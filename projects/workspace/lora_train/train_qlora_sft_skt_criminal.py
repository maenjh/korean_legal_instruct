"""
QLoRA + TRL SFTTrainer를 사용한 Instruct 학습 코드 (형사법 버전)
Train: /workspace/data/04.형사법 LLM 사전학습 및 Instruction Tuning 데이터/3.개방데이터/1.데이터/Training/criminal_law_instruct.jsonl
Valid: /workspace/data/04.형사법 LLM 사전학습 및 Instruction Tuning 데이터/3.개방데이터/1.데이터/Validation/criminal_law_instruct_val.jsonl
...
# 형사법 학습 데이터
DATA_PATH = "/workspace/data/04.형사법 LLM 사전학습 및 Instruction Tuning 데이터/3.개방데이터/1.데이터/Training/criminal_law_instruct.jsonl"

# 형사법 검증 데이터
VAL_DATA_PATH = "/workspace/data/04.형사법 LLM 사전학습 및 Instruction Tuning 데이터/3.개방데이터/1.데이터/Validation/criminal_law_instruct_val.jsonl"

OUTPUT_DIR = "/workspace/outputs/qlora-sft-criminal-law-skt"
    ...
    with open(data_path, 'r', encoding='utf-8') as f:
        for line_num, line in enumerate(f, 1):
            try:
                ...
                # 지원 포맷:
                # 1) {"taskinfo": {"instruction":..., "input":..., "output":...}}
                # 2) {"label": {"instruction":..., "input":..., "output":...}, ...}
                instruction = ""
                input_text = ""
                output = ""
...
def train():
    print("=" * 50)
    print("QLoRA + TRL SFTTrainer 학습 시작 (형사법)")
    print("=" * 50)
