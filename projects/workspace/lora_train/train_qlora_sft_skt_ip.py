"""
QLoRA + TRL SFTTrainer를 사용한 Instruct 학습 코드 (지식재산권법 버전)
Train: /workspace/data/02.지식재산권법 LLM 사전학습 및 Instruction Tuning 데이터/3.개방데이터/1.데이터/Training/ip_law_instruct_train.jsonl
Valid: /workspace/data/02.지식재산권법 LLM 사전학습 및 Instruction Tuning 데이터/3.개방데이터/1.데이터/Validation/intellectual_property_law_instruct_val.jsonl
...
# 지식재산권법 학습 데이터
DATA_PATH = "/workspace/data/02.지식재산권법 LLM 사전학습 및 Instruction Tuning 데이터/3.개방데이터/1.데이터/Training/ip_law_instruct_train.jsonl"

# 지식재산권법 검증 데이터
VAL_DATA_PATH = "/workspace/data/02.지식재산권법 LLM 사전학습 및 Instruction Tuning 데이터/3.개방데이터/1.데이터/Validation/intellectual_property_law_instruct_val.jsonl"

OUTPUT_DIR = "/workspace/outputs/qlora-sft-intellectual-property-law-skt"
...
def train():
    print("=" * 50)
    print("QLoRA + TRL SFTTrainer 학습 시작 (지식재산권법)")
    print("=" * 50)
